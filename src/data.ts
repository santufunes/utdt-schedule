...
export const FOOTNOTES: string[] = [
  ...
  'Con el lápiz (✎) podés editar día, hora, aula o sección de cualquier opción, quitarla o agregar opciones nuevas (p. ej. si una cátedra cambia un horario). Los cambios se marcan con ✎, se pueden restaurar al original y también se sincronizan entre tus dispositivos.',
]
